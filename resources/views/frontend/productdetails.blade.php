            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        <div class="item">
                            <img src="{{ asset('uploads/product_photos') }}/{{ $product_info->product_thumbnail_photo }}" alt="no image">
                        </div>
                        @foreach ($product_info->onetomany as $single_image)
                          <div class="item">
                            <img src="{{ asset('uploads/product_multiple_photo') }}/{{ $single_image->product_image_name }}" alt="no image">
                          </div>
                        @endforeach
                    </div>
                ...
                <div class="product-single-content">
                    ...
                    <ul class="input-style">
                      <form class="" action="{{ route('cart.store') }}" method="post">
                        ...
                        <li><button type="submit" class="btn btn-danger">Add to Cart</a></li>
                      </form>
                    </ul>
                    <ul class="cetagory">
                        <li>Category:</li>
                        <li><a href="#">{{ $product_info->onetoone->category_name }}</a></li>
                    </ul>
                    <ul class="socil-icon">
                        <li>Share :</li>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    <div class="featured-product-img">
                        <img src="{{ asset('uploads/product_photos') }}/{{ $related_product->product_thumbnail_photo}}" alt="No image">
                    </div>
